      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="prose prose-slate max-w-none">
          ...
          <ul className="mt-4 space-y-2 text-slate-600">
            ...
            <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-green-600" /> <strong>Email:</strong> elrecolector2024sl@gmail.com</li>
          </ul>
          ...
          <p className="mt-4 text-slate-600">
            Puede ejercer sus derechos de acceso, rectificación, cancelación y oposición contactando con nosotros a través del email elrecolector2024sl@gmail.com.
          </p>
